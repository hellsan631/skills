<!-- humanize-lint: ignore-file list-density — evidence source card: an inventory of what a source holds plus the ordered queries that search it, which is a list by nature -->
